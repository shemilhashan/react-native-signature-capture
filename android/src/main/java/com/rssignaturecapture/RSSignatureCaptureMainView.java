...
public class RSSignatureCaptureMainView extends LinearLayout implements OnClickListener, RSSignatureCaptureView.SignatureCallback {
    ...
    String uniqueID = "SIG_image";
    Context reactContex = null;
    ...
    public void setImageId(String imageId) {
        if (savePath == null) {
            this.uniqueID = "SIG_image";
        } else {
            this.uniqueID = imageId;
        }
    }
    ...
    final void saveImage() {
        ...
        Log.d("SIGNATURE:",  "savePath :"+this.savePath);
        // the directory where the signature will be saved
        File myDir = new File(this.savePath);
        ...
        String fname = this.uniqueID + ".jpg";
        Log.d("SIGNATURE:",  "myDir :"+ myDir);
        Log.d("SIGNATURE:",  "fname :"+ fname);
        ...
        try {
            ...
            event.putString("imageId", this.uniqueID);
